...
create or refresh streaming live table dig_order_brz
as select current_timestamp() ingest_time,input_file_name() File_name, * from 
cloud_files("${source}/orders","json",map("cloudFiles.inferColumnTypes","true") )
