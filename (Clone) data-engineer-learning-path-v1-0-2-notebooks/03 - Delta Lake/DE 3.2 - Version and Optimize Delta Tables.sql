...
--restore table emp to version as of 1
--delete from emp;

--describe history emp;

--restore table emp to version as of 7;

create schema emp location 
--describe schema extended emp;

--use schema emp;
--create table eemp1(id string)
...
-- MAGIC %python
-- MAGIC display(dbutils.fs.ls("dbfs:/mnt/dbacademy-users/digambarj@ilink-systems.com/data-engineer-learning-path/database.db/students/_delta_log/"))
