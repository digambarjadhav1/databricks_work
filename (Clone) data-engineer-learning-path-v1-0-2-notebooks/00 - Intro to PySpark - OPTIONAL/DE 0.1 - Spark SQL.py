...
# MAGIC %sql
# MAGIC SELECT row_number()over (partition by name order by price DESC) as CNT,name,price
# MAGIC FROM products
# MAGIC
...
df2.createTempView("diga_tbl_2")

# COMMAND ----------

display(spark.sql("select * from diga_tbl_2"))
