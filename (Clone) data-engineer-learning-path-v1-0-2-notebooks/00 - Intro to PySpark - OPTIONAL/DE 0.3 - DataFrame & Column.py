...
print(event_df.device)
display(event_df.device)
print(event_df["device"])
print("\n THIs is line spacer \n")
print(col("device"))
...
revenue_df=(event_df
            ...
            .withColumn("purchased_revenue",(col("ecommerce.purchase_revenue_in_usd") * 100).cast("int"))
            .filter(col("device")!="Windows")
            .withColumn("Average_purchased_revenue",col("ecommerce.purchase_revenue_in_usd") / col("ecommerce.total_item_quantity"))
            .sort(col("Average_purchased_revenue").desc())
            .select(col("Average_purchased_revenue"),col("device"),col("ecommerce.purchase_revenue_in_usd"),col("ecommerce.total_item_quantity"),col("ecommerce"))
            )
display(revenue_df)
